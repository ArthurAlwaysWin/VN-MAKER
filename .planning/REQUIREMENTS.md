...
- [ ] **WIDGET-01**: 引擎从 `ui.widgetStyles` 读取控件风格配置（tab/toggle/slider/panel/button），与内置默认值深合并
...
- [ ] **WIDGET-05**: Panel 和 Button 的背景/圆角/边框/模糊效果/背景贴图由 `widgetStyles.panel` 和 `widgetStyles.button` 驱动
