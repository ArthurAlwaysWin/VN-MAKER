...
- [ ] **BTN-01**: 用户可以为 3 个非选中态按钮族配置 `normal / hover / pressed` 图片态：`game-menu-button`、`QAB`、`close-button family`
- [ ] **BTN-02**: 用户可以为 2 个需要选中态的按钮族配置 `normal / hover / pressed / selected` 图片态：`page-tab / pager`、`settings-tab`
...
|-------------|-------|--------|
| DLG-01 | Phase TBD | Pending |
| DLG-02 | Phase TBD | Pending |
| DLG-03 | Phase TBD | Pending |
| BTN-01 | Phase TBD | Pending |
| BTN-02 | Phase TBD | Pending |
| BTN-03 | Phase TBD | Pending |
| SCR-01 | Phase TBD | Pending |
| SCR-02 | Phase TBD | Pending |
| SCR-03 | Phase TBD | Pending |
| CUR-01 | Phase TBD | Pending |
| ICO-01 | Phase TBD | Pending |
| AST-01 | Phase TBD | Pending |
| AST-02 | Phase TBD | Pending |
| AST-03 | Phase TBD | Pending |
| AST-04 | Phase TBD | Pending |
| AST-05 | Phase TBD | Pending |
| AST-06 | Phase TBD | Pending |
...
*Last updated: 2026-04-22 after initial v1.5 definition*
