...
**Plans**: 2 plans
Plans:
- [x] 26-01-PLAN.md — Theme editor core: tab registration, composable, iframe preview, all 41 token controls with WCAG badges
- [x] 26-02-PLAN.md — Palette generator modal + 9-slice configuration modal
**UI hint**: yes
