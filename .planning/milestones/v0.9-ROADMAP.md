...
- [x] 35-02-PLAN.md — 编辑器 UI 文本中文化 (字体选择器/转场/AudioPicker/ExportModal/坐标/占位符)
...
**Plans:** 2/2 plans complete
Plans:
- [x] 36-01-PLAN.md — HelpTip 组件 + helpTexts.js + 主题/导出/设置区帮助集成
- [x] 36-02-PLAN.md — 剧本/资源/设计器帮助集成 + 按钮 title 全覆盖扫描
