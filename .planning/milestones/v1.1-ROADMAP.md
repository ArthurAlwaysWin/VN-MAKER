...
- [x] **Phase 45: 名牌样式 + 配置统一 + 编辑器预览** — DialogueBox nameplateStyle 三种样式 + main.js 统一配置传入 + 编辑器 iframe 预览集成 (completed 2026-04-16)
...
| 45. 名牌样式 + 配置统一 + 编辑器预览 | 2/2 | Complete   | 2026-04-16 |