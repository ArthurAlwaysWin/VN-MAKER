...
Plans:
- [x] `78-01-PLAN.md` — Freeze `.gmtheme` schema, canonical namespace rules, and deterministic re-import policy
- [x] `78-02-PLAN.md` — Wire dry-run import preflight and legacy compatibility UX without Phase 79 install/apply work
...
Plans:
- [x] `82-01-PLAN.md` — Harden built-in completeness truth, browser honesty, and shared built-in asset materialization before theme production
- [x] `82-02-PLAN.md` — Promote `default` and `modern-sky` into explicit full themes with canonical assets and distinct preview/signature metadata
- [x] `82-03-PLAN.md` — Promote `fantasy-dark` and `minimal-white` into explicit full themes with canonical assets and distinct preview/signature metadata
- [x] `82-04-PLAN.md` — Prove 5-theme parity across the shared pipeline and run the final shipped-theme visual review
