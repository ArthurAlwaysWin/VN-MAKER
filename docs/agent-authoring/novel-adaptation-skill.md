...
- Use ending registry and unlock commands for endings. Use the CG registry and `unlock:cg` operations for major-beat artwork that should appear in the supported gallery.
