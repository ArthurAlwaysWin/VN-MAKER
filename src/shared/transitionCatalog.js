...
export const TRANSITION_CATALOG = Object.freeze([
  ...
  defineTransition({ id: 'wipe-left', label: '左向擦除', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'wipe-right', label: '右向擦除', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'wipe-up', label: '向上擦除', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'wipe-down', label: '向下擦除', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'zoom-in', label: '推近', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'scale' }),
  defineTransition({ id: 'zoom-out', label: '拉远', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'scale' }),
  defineTransition({ id: 'flash', label: '闪白', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 400 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'iris-in', label: '光圈进入', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'iris-out', label: '光圈退出', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 800 }, runtimeSupported: false, editorSupported: false, fallbackId: 'fade' }),
  defineTransition({ id: 'crossfade-pan', label: '溶解平移', target: 'background', storageField: 'transition.type', paramsSchema: backgroundParams, defaults: { duration: 1000 }, runtimeSupported: false, editorSupported: false, fallbackId: 'dissolve' }),
  ...
  defineTransition({ id: 'fade', label: '淡入', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'fade-in' }),
  defineTransition({ id: 'slide-left', label: '左滑入', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'slide-in-left' }),
  defineTransition({ id: 'slide-right', label: '右滑入', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'slide-in-right' }),
  defineTransition({ id: 'pop', label: '弹出', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'fade-in' }),
  defineTransition({ id: 'scale-in', label: '缩放进入', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'fade-in' }),
  defineTransition({ id: 'blur-in', label: '模糊进入', target: 'character', storageField: 'animation', runtimeSupported: false, editorSupported: false, fallbackId: 'fade-in' }),
  ...
  defineTransition({ id: 'vignette', label: '暗角', target: 'camera', storageField: 'camera.effect', paramsSchema: cameraParams, defaults: { durationMs: 800, intensity: 'medium' }, runtimeSupported: false, editorSupported: false, fallbackId: null }),
  defineTransition({ id: 'letterbox', label: '宽银幕', target: 'camera', storageField: 'camera.effect', paramsSchema: cameraParams, defaults: { durationMs: 800, intensity: 'medium' }, runtimeSupported: false, editorSupported: false, fallbackId: null }),
]);
