...
export const TRANSITION_CATALOG = Object.freeze([
  ...
  defineTransition({ id: 'noise-dissolve', label: '噪点溶解', target: 'background', storageField: 'transition.type', category: 'canvas-mask', renderMode: 'canvas-mask', description: 'Procedural canvas noise veil over a safe crossfade.', paramsSchema: backgroundParams, defaults: { duration: 900 }, runtimeSupported: true, editorSupported: true, fallbackId: 'dissolve' }),
  defineTransition({ id: 'ripple', label: '水波纹', target: 'background', storageField: 'transition.type', category: 'canvas-mask', renderMode: 'canvas-mask', description: 'Procedural canvas ripple rings over a safe crossfade.', paramsSchema: backgroundParams, defaults: { duration: 900 }, runtimeSupported: true, editorSupported: true, fallbackId: 'crossfade-pan' }),
  defineTransition({ id: 'burn', label: '燃烧', target: 'background', storageField: 'transition.type', category: 'canvas-mask', renderMode: 'canvas-mask', description: 'Procedural canvas ember edge over a safe crossfade.', paramsSchema: backgroundParams, defaults: { duration: 950 }, runtimeSupported: true, editorSupported: true, fallbackId: 'fade-white' }),
