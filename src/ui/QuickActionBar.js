...
export class QuickActionBar {
  ...
  _render() {
    ...
    this.el.innerHTML = `
      <button class="qab-btn" data-action="auto" title="自动">
        <svg ${svgAttrs}><polygon points="6 3 20 12 6 21 6 3"></polygon></svg>
      </button>
      <button class="qab-btn" data-action="skip" title="快进">
        <svg ${svgAttrs}><polygon points="13 19 22 12 13 5 13 19"></polygon><polygon points="2 19 11 12 2 5 2 19"></polygon></svg>
      </button>
      <button class="qab-btn" data-action="backlog" title="回想">
        <svg ${svgAttrs}><path d="M15 12h-5"></path><path d="M15 8h-5"></path><path d="M19 17V5a2 2 0 0 0-2-2H4"></path><path d="M8 21h12a2 2 0 0 0 2-2v-1"></path><path d="M3 7v13a1 1 0 0 0 1 1h3"></path></svg>
      </button>
      <button class="qab-btn" data-action="save" title="存档">
        <svg ${svgAttrs}><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"></path><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"></path><path d="M7 3v4a1 1 0 0 0 1 1h7"></path></svg>
      </button>
      <button class="qab-btn" data-action="load" title="读档">
        <svg ${svgAttrs}><path d="m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2"></path></svg>
      </button>
      <button class="qab-btn" data-action="quicksave" title="快存">
        <svg ${svgAttrs}><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path><line x1="12" x2="12" y1="7" y2="13"></line><line x1="15" x2="9" y1="10" y2="10"></line></svg>
      </button>
      <button class="qab-btn disabled" data-action="quickload" title="快读">
        <svg ${svgAttrs}><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path><path d="m9 10 2 2 4-4"></path></svg>
      </button>
      <button class="qab-btn" data-action="settings" title="设置">
