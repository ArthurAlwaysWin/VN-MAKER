...
function printHelp() {
  ...
  set-page-transition --scene scene_id --page index [--type fade|dissolve|wipe|wipe-left|wipe-right|wipe-up|wipe-down|scale|blur|slide-left|slide-right|none] [--duration number] [--transition json] [--clear-transition] [--script path] [--out path] [--dry-run] [--force] [--backup] [--checkpoint] [--json]
  set-page-transitions --scene scene_id [--from-page index] [--to-page index] [--page-type normal|choice|condition] [--has-background|--without-background] [--predicate json] [--type fade|dissolve|wipe|wipe-left|wipe-right|wipe-up|wipe-down|scale|blur|slide-left|slide-right|none] [--duration number] [--transition json] [--clear-transition] [--script path] [--out path] [--dry-run] [--force] [--backup] [--checkpoint] [--json]
